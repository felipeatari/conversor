...
class Router
{
  ...
  public function dispatcher()
  {
    ...
    if ($this->http_status_code !== 200) {
      if ($this->http_status_code === 405) $message_error = 'Method not Implemented';
      elseif ($this->http_status_code === 404) $message_error = 'Not Found';

      if ($this->callback) {
        die(ErrorController::error_api($this->http_status_code, $message_error));
      }

      die(ErrorController::error($this->http_status_code, $message_error));
    }
